<?php
	$soalapa="artikel"; // menentukan tabel apa yang dipilih
	$menu_title = "Artikel"; // menentukan judul halaman ini
		...
		<div class="wrapper">
			...
			<div class="page-content">	
				...
				<div class="container-fluid">
					...
					<div class="the-box">
						<form id="myForm" method="post" action="<?php echo $soalapa ?>_action.php?action=input" class="form-horizontal" enctype="multipart/form-data" >
