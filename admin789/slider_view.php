							...
							<tbody>
								<?php
									...
									while ($satuan = mysqli_fetch_assoc($query)) {
										  ...
										  <div class="modal-dialog">
											<div class="modal-content">
											  <div class="modal-header">
												...
												<h4 class="modal-title" id="DefaultModalLabel"><center> Apakah Anda Yakin akan menghapus data ?</center></h4>
											  </div>
										...
										<tr class="odd gradeX">
											<td><?php echo $no ?></td>
                                            <td width="40%"><img src="../images/slider/<?php echo $satuan['image'] ?>" width="70%" > </td>
											<td width="20%"><h4><?php echo $satuan['title'] ?></h4></td>                                            
                                            <td width="10%"><h4><?php echo $satuan['status'] ?></h4></td>
											<td width="20%"><a href="<?php echo $soalapa ?>_edit.php?id=<?php echo $satuan['id'] ?>">Edit</a> / <a data-toggle="modal" data-target="#DefaultModal<?php echo $no ?>" href="#" >Hapus</a></td>
										</tr>
