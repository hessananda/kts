<?php
	...
	$html->display_main('Input Gallery');
	$page = "Slider"
?>
		<!--
		===========================================================
			...
			<div class="page-content">	
				...
				<div class="container-fluid">
					...
					<ol class="breadcrumb default square rsaquo sm">
						...
						<li class="active">Daftar <?php echo $menu_detail_title ?></li>
					</ol>
					<!-- End breadcrumb -->
					...
					<div class="the-box">
						<form id="eventform" method="post" action="<?php echo $soalapa ?>_action.php?action=input" class="form-horizontal" enctype="multipart/form-data" >
							...
							<?php file_input ('Image','file','input gambar landscape') ?>								
							<?php textbox('Title','title','') ?>                                                                                                                                 
