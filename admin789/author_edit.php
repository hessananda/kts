				...
				<div class="container-fluid">
					...
					<div class="the-box">
						<form id="eventform" method="post" action="<?php echo $soalapa ?>_action.php?action=edit&id=<?php echo $id ?>" class="form-horizontal" enctype="multipart/form-data" >
							...
							<?php textbox_update('Nama','nama',$satuan['nama']) ?>							
							<?php file_gambar_update('../images/author/',$satuan['image'],'file','english') ?>								
							<?php textbox_update('Email','email',$satuan['email']) ?>	
                            <?php textbox_update('Telepon','phone',$satuan['phone']) ?>
                            <?php textbox_update('Keterangan','keterangan',$satuan['keterangan']) ?>	
