<?php
	$soalapa="contact_us"; // menentukan tabel apa yang dipilih
	$menu_title = "Contact Us "; // menentukan judul halaman ini
		...
		<div class="wrapper">
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					...
					<div class="the-box">
                                            <form id="eventform" method="post" action="contact_us_action.php?action=edit&id=<?php echo $id ?>" class="form-horizontal" enctype="multipart/form-data" >
						
							<fieldset>
								<legend>Edit <?php echo $menu_title ?></legend>

							<?php textbox_update('Kirim Contact Us ke Email :','email',$satuan['email']) ?>					
