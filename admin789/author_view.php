							...
							<tbody>
								<?php
									...
									while ($satuan = mysqli_fetch_assoc($query)) {
										  ...
										  <div class="modal-dialog">
											<div class="modal-content">
											  <div class="modal-header">
												...
												<h4 class="modal-title" id="DefaultModalLabel"><center> Apakah Anda Yakin akan menghapus data <br><b><?php echo $satuan['nama'] ?> </b> ?</center></h4>
											  </div>
										...
										<tr class="odd gradeX">
											<td><?php echo $no ?></td>
                                                                                        <td width="200"><img src="../images/author/<?php echo $satuan['image'] ?>" width="70%" > </td>
											<td><?php echo $satuan['nama'] ?></td>
                                                                                        <td><?php echo $satuan['phone'] ?></td>
